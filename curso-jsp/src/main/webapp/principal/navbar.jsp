...
<nav class="navbar header-navbar pcoded-header">
              <div class="navbar-wrapper">
                  <div class="navbar-logo">
                      ...
                      <a href="index.html">
                          <img class="img-fluid" src="<%= request.getContextPath() %>/assets/images/logo3.jpeg" alt="Theme-Logo" style="height: 40px;"/>
                      </a>
                      ...
                      <ul class="nav-right">
                                  ...
                                  <li class="waves-effect waves-light">
                                      <div class="media">
                                          ...
                                          <div class="media-body">
                                              <h5 class="notification-user"><% out.print(session.getAttribute("usuario")); %></h5>
                                              <!-- <h5 class="notification-user">${sessionScope.usuario}</h5> -->
                          ...
                          <li class="user-profile header-notification">
                              <a href="#!" class="waves-effect waves-light">
                                  ...
                                  <span><% out.print(session.getAttribute("usuario")); %></span>
