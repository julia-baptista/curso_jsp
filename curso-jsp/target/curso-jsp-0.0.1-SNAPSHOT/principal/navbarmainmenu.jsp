                          ...
                          <div class="">
                              <div class="main-menu-header">
								  ...
								  <c:if test="${imagemUser != '' && imagemUser != null}">	
										<img class="img-80 img-radius" alt="Imagem User" src="${imagemUser}" style="width: 80px; height: 80px; object-fit: cover; border: 2px solid white;" />
								  </c:if>
								  <c:if test="${imagemUser == '' || imagemUser == null}">
									    <img class="img-80 img-radius" alt="Imagem User" src="assets/images/iconuser.png" style="width: 80px; height: 80px; object-fit: cover; border: 2px solid white;" />
								  </c:if>
								  <div class="user-details">
                                      <span id="more-details"><%
                                      out.print(session.getAttribute("usuario"));
                                      %><i class="fa fa-caret-down"></i></span>
                                      <!--  <span id="more-details">${sessionScope.usuario}<i class="fa fa-caret-down"></i></span> -->
                                  </div>
                              </div> 
